<div class="facebookAuths form">
<?php echo $this->Form->create('FacebookAuth');?>
	<fieldset>
		<legend><?php __('Edit Facebook Auth'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('Delete', true), array('action' => 'delete', $this->Form->value('FacebookAuth.id')), null, sprintf(__('Are you sure you want to delete # %s?', true), $this->Form->value('FacebookAuth.id'))); ?></li>
