...
<div class="span10">
	...
	<tr<?php echo $class;?>>
		...
		<td><?php echo $application['Application']['created']; ?>&nbsp;</td>
		<td><?php echo $application['Application']['modified']; ?>&nbsp;</td>
		<td class="actions">
			<?php echo $this->Html->link(__('View', true), array('action' => 'view', $application['Application']['id'])); ?>
			<?php echo $this->Html->link(__('Edit', true), array('action' => 'edit', $application['Application']['id'])); ?>
